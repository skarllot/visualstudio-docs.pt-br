...
|**Categoria**|**Links**|  
|------------------|---------------|  
|**Vídeos**|![link para vídeo](~/docs/data-tools/media/playvideo.gif "PlayVideo") [MSDN vídeos como faço para: como criar e usar modelos e diagramas UML (Visual Studio 2010 Ultimate)](http://go.microsoft.com/fwlink/?LinkId=214460)<br /><br /> ![link para vídeo](~/docs/data-tools/media/playvideo.gif "PlayVideo") [Channel 9: UML com o Visual Studio 2010](http://go.microsoft.com/fwlink/?LinkID=201106)<br /><br /> ![link para vídeo](~/docs/data-tools/media/playvideo.gif "PlayVideo") [série MSDN How Do I: ferramentas UML e extensibilidade (Visual Studio 2010 Ultimate)](http://go.microsoft.com/fwlink/?LinkID=214467)|  
