---
title: Oculto (modelos do Visual Studio) elemento | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: 626f40ffc2939d65d04391786585f1ec21b62133
ms.lasthandoff: 02/22/2017

---
# <a name="hidden-element-visual-studio-templates"></a>Elemento oculto (modelos do Visual Studio)
Especifica se o modelo aparece no **novo projeto** ou **Adicionar Novo Item** caixa de diálogo.  
