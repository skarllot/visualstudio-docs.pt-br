---
title: Elemento CommandPlacements | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
ms.openlocfilehash: eaaed3b0fcc12a1ed15ae04ea91698f7b1aa3294
...
|[Elemento CommandPlacement](../extensibility/commandplacement-element.md)|Habilita os botões, grupos e menus ser incluído em mais de um grupo ou menu.|  
