---
title: IDebugComPlusSymbolProvider2::GetTypeFromToken | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
#### <a name="parameters"></a>Parâmetros  
 ...
 `ppField`  
 [out] Retorna o tipo é representado pelo [IDebugField](../../../extensibility/debugger/reference/idebugfield.md).  
