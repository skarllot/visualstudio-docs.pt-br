 ...
 **Validando um manifesto de imagem personalizada**  
 ...
 ![Visualizador de biblioteca de imagens pode tema](~/docs/extensibility/internals/media/image-library-viewer-can-theme.png "Visualizador da biblioteca de imagens pode tema")  
