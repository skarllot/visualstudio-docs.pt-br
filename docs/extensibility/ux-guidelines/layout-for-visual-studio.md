 ...
 **Figura 08.01-h: Caixa de diálogo com temas**  
 ...
 ![Dimensões da caixa de diálogo com temas](~/docs/extensibility/ux-guidelines/media/0801-i_themeddialogdimensions.png "0801 i_ThemedDialogDimensions")  
 ...
 **Figura 08.01-j: Temas diálogo – fontes**  
 ...
 ![Cores do tema diálogo](~/docs/extensibility/ux-guidelines/media/0801-k_themeddialogcolors.png "0801 k_ThemedDialogColors")  
