---
title: GUIDs IDE | Documentos do Microsoft
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
O <xref:Microsoft.VisualStudio.VSConstants>classe publica GUIDs de algumas partes do ambiente de desenvolvimento integrado (IDE), conforme listado na tabela a seguir.</xref:Microsoft.VisualStudio.VSConstants>  
...
## <a name="broadly-visible-components"></a>Amplamente os componentes visíveis  
