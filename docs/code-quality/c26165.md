...
Aviso C26165: Possível falha ao liberar bloqueio \<lock\> na função \<fun\>.  
 ...
 C26165 de aviso se assemelha a [C26115](../code-quality/c26115.md) de aviso exceto que o nível de confiança é mais baixo.  Por exemplo, a função pode conter erros da anotação.  
