...
2.  Na página de propriedades do projeto, escolha **Análise de Código** e **Habilitar Análise de Código para C/C++ no build**.  
 ...
 ![Janela Análise de Código](~/docs/test/media/ca_cpp_collapsed.png "CA_CPP_Collapsed")  
...
##  <a name="BKMK_Analyze"></a> Analisando e resolvendo avisos da análise de código  
 ...
 ![Aviso de análise de código expandido](~/docs/test/media/ca_cpp_expanded_callout.png "CA_CPP_Expanded_Callout")  
 ...
 ![Código-fonte destacado](~/docs/test/media/ca_cpp_sourceline.png "CA_CPP_SourceLine")  
