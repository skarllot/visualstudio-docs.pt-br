...
2.  No Gerenciador de Soluções, abra MainPage.xaml. Na Caixa de Ferramentas, arraste um controle de botão e um controle de caixa de texto para a superfície do design.  
     ...
     ![Adicionar controles a MainPage.xaml](~/docs/test/media/cuit_phone_app_addcontrols.png "CUIT_Phone_App_AddControls")  
...
2.  Escolha editar o mapa de interface do usuário usando a ferramenta de fios.  
     ...
     ![Gerar um teste de IU codificado usando a ferramenta de fios.] (~/docs/test/media/cuit_phone_howgencodedialog.png "CUIT_Phone_HowGenCodeDialog")  
