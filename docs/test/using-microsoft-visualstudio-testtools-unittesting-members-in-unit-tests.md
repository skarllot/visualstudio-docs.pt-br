...
ms.openlocfilehash: 14ab48cc725fe77915e799dca1824e5f0495bc82
...
A Estrutura de Teste de Unidade dá suporte a testes de unidade no [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]. Use as classes e membros do namespace <xref:Microsoft.VisualStudio.TestPlatform.UnitTestFramework> ao codificar testes de unidade. É possível usá-los ao gravar o teste de unidade do zero ou refinar um teste de unidade gerado do código em teste.  
