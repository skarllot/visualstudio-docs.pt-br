...
|Parâmetro|Descrição|  
|---------------|-----------------|  
|`DeploymentManifestEntryPoint`|Parâmetro opcional <xref:Microsoft.Build.Framework.ITaskItem>.<br /><br /> Especifica o nome do manifesto de implantação.|  
|`EntryPoint`|Parâmetro opcional <xref:Microsoft.Build.Framework.ITaskItem>.<br /><br /> Especifica o assembly gerenciado ou a referência do manifesto do ClickOnce que é o ponto de entrada para o manifesto.|  
...
|`OutputDeploymentManifestEntryPoint`|Parâmetro de saída opcional <xref:Microsoft.Build.Framework.ITaskItem>.<br /><br /> Especifica o ponto de entrada do manifesto de implantação de saída.|  
|`OutputEntryPoint`|Parâmetro de saída opcional <xref:Microsoft.Build.Framework.ITaskItem>.<br /><br /> Especifica o ponto de entrada de saída.|  
