...
1. No barra de pesquisa **Início Rápido** (Ctrl + Q), digite `dotfuscator`. <br/> <br/> ![](~/docs/ide/dotfuscator/media/install_from_vs_12.png) <br/> <br/>
...
4. Feche todas as instâncias do IDE do Visual Studio. <br/> <br/> ![](~/docs/ide/dotfuscator/media/install_from_vs_345.png) <br/> <br/>
...
2. Em *Ferramentas de código*, marque o item *PreEmptive Protection – Dotfuscator*.<br/> <br/> ![](~/docs/ide/dotfuscator/media/install_individually_12.png) <br/> <br/>
3. O painel *Resumo* exibe *PreEmptive Protection – Dotfuscator* na seção *Componentes Individuais*. <br/> <br/> ![](~/docs/ide/dotfuscator/media/install_individually_3.png) <br/> <br/>
