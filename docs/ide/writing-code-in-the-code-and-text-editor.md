...
![Botões de navegação para frente e para trás](~/docs/ide/media/vs2017_nav_buttons.png)
...
![Visualizador de Estrutura](~/docs/ide/media/vside_structure_visualizer.png)
...
|Exibir Hierarquia de Chamada|(Menu de contexto ou CTRL + K, CTRL + T).|  
 ...
 ![Barra de navegação de código](~/docs/ide/media/vside_navigation_bar.png)
...
1. Na caixa de texto, digite o nome do elemento de código que você deseja localizar.
    ...
    ![Janela Navegar Para](~/docs/ide/media/vside_navigatetowindow.png "Janela Navegar Para")
...
![Janela Navegar Para – pesquisando com letras maiúsculas](~/docs/ide/media/vside_capitalsearch.png)
...
![Janela de ferramentas Localizar Todas as Referências](~/docs/ide/media/vside_findallreferences.png)
