...
2. Pressione **Ctrl + .** em qualquer lugar de uma linha para invocar a lâmpada e ir diretamente para a lista de possíveis correções.  
   ...
   ![Lâmpada com o mouse focalizando](~/docs/ide/media/vs2015_lightbulb_hover.png "VS2017_LightBulb_Hover")  
...
![Refatoração - resolver conflitos de mesclagem](~/docs/ide/media/vside-refactoring-merge-conflicts.png)
...
![Refatoração - adicionar verificação de nulos](~/docs/ide/media/vside-refactoring-nullcheck.png)
...
![Refatoração - gerar construtores](~/docs/ide/media/vside-refactoring-constructors.png)
...
![Refatoração - variáveis não utilizadas](~/docs/ide/media/vside-refactoring-unusedvars.png)
...
![Refatoração - substituições](~/docs/ide/media/vside-refactoring-overrides.png)

![Refatoração - caixa de diálogo de substituições](~/docs/ide/media/vside-refactoring-overrides-dialog.png)
...
![Refatoração - alterar base](~/docs/ide/media/vside-refactoring-changebase1.png)

![Refatoração - alterar base](~/docs/ide/media/vside-refactoring-changebase2.png)
...
![Refatoração - alterar separadores de dígitos](~/docs/ide/media/vside-refactoring-separators.png)
