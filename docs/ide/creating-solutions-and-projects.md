...
## <a name="download-sample-solutions"></a>Baixar soluções de amostra  
...
## <a name="add-single-files-at-the-solution-level"></a>Adicionar arquivos individuais no nível da solução  
...
### <a name="delete-solutions"></a>Excluir soluções  
