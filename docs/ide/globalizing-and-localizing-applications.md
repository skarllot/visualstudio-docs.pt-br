...
## <a name="related-sections"></a>Seções relacionadas  
 ...
 Contém tópicos de instruções e diretrizes para ajudá-lo a globalizar e localizar seu aplicativo [!INCLUDE[win8_appname_long](../debugger/includes/win8_appname_long_md.md)] criado com o XAML e Visual C#, Visual Basic ou Visual C++.  
