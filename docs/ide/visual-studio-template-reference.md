...
ms.openlocfilehash: 1bc1f8cd373cc591b3413ad14583f6933de3d2d0
ms.contentlocale: pt-br
ms.lasthandoff: 05/19/2017

---
# <a name="visual-studio-template-reference"></a>Referência de modelo do Visual Studio
Os links a seguir apresentam informações de referência sobre os diferentes aspectos de modelos de projeto e item [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
