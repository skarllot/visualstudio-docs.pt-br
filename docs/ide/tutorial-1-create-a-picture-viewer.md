...
-   Escrever métodos de manipulador de eventos.  
 ...
 ![Imagem criada neste tutorial](~/docs/ide/media/express_pictureviewerdone.png "Express_PictureViewerDone")  
