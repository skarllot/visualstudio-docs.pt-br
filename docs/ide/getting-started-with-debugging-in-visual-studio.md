...
### <a name="configuring-a-build"></a>Configurando um build  
 ...
 ![Botão Depurar Build do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_type1.PNG "Vs_ide_gs_debug_build_type1")  
 ...
 ![Janela do Gerenciador de Arquivos de Configuração do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_cf_mgr.PNG "Vs_ide_gs_debug_build_cf_mgr")  
 ...
 ![Janela do Gerenciador de Configurações do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_cf_mgr_2.PNG "Vs_ide_gs_debug_build_cf_mgr_2")  
...
### <a name="building-your-code"></a>Compilando seu código  
 ...
 ![Seleção de menu do projeto de build do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_build_menu_item.png "Vs_ide_gs_debug_build_menu_item")  
 ...
 ![Saída de build bem-sucedido do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_success_build.PNG "vs_ide_gs_debug_success_build")  
...
### <a name="reviewing-the-error-list"></a>Revisando a Lista de Erros  
 ...
 ![Lista de Erros e Saída do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_bad_build_error_list.PNG "Vs_ide_gs_debug_bad_build_error_list")  
 ...
 ![Editor com números de linha do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_line_numbers.png "Vs_ide_gs_debug_line_numbers")  

 ![Opção de números de linha do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_options_line_numbers.png "Vs_ide_gs_debug_options_line_numbers")  
 ...
 ![Focalizar o erro no Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_hover1.png "Vs_ide_gs_debug_error_hover1")  

 Percorra a lista de erros e resolva todos os erros em seu código.  

 ![Janela de erros de depuração do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_list.PNG "Vs_ide_gs_debug_error_list")  
...
### <a name="reviewing-errors-in-detail"></a>Revisando os erros detalhadamente  
 ...
 ![Pesquisa do Bing da lista de erros do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_error_list_error_help.png "Vs_ide_gs_debug_error_list_error_help")  
...
### <a name="performing-static-code-analysis"></a>Realizando a análise de código estático  
 ...
 ![Item de menu Análise de Código no Visual Studio](~/docs/ide/media/vs_ide_gs_debug_run_code_analysis.png "Vs_ide_gs_debug_run_code_analysis")  
 ...
 ![Lista de Erros com Avisos do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_code_analysis_warning_error_list.PNG "vs_ide_gs_debug_code_analysis_warning_error_list")  
 ...
 ![Foco do Aviso da Análise de Código do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_code_analysis_warning_hover.png "vs_ide_gs_debug_code_analysis_warning_hover")  
...
### <a name="using-light-bulbs-to-fix-or-refactor-code"></a>Usando as lâmpadas para corrigir ou refatorar o código  
 ...
 ![Opções rápidas da lâmpada do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb1.png "Vs_ide_gs_debug_light_bulb1")  

 Você verá uma lista de possíveis correções ou refatorações que podem ser aplicadas àquela linha de código.  

 ![Visualização da lâmpada do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb_preview_changes.PNG "Vs_ide_gs_debug_light_bulb_preview_changes")  
 ...
 ![Texto “sem opções” da lâmpada do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_light_bulb_no_options.PNG "Vs_ide_gs_debug_light_bulb_no_options")  
...
### <a name="debugging-your-running-code"></a>Depurando seu código em execução  
 ...
 ![Janelas Autos e Pilha de Chamadas do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_autos_and_call_stack.PNG "Vs_ide_gs_debug_autos_and_call_stack")  
 ...
 ![Botão Interromper Tudo do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_break_all_button.png "vs_ide_gs_debug_break_all_button")  

 Pressione F5 para continuar a execução do aplicativo (ou clique no botão **Continuar**).  

 ![Botão Continuar Depuração do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_continue_button.png "Vs_ide_gs_debug_continue_button")  
...
### <a name="setting-simple-breakpoints"></a>Configuração pontos de interrupção simples  
 ...
 ![Ponto de interrupção do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_breakpoint1.png "Vs_ide_gs_debug_breakpoint1")  
...
### <a name="setting-conditional-breakpoints"></a>Configurando pontos de interrupção condicionais  
 ...
 ![Configurações de ponto de interrupção do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_breakpoint_settings.png "Vs_ide_gs_debug_breakpoint_settings")  

 Você verá uma caixa de diálogo semelhante a essa em que pode definir condições específicas para que a interrupção ocorra.  

 ![Ponto de interrupção condicional do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_breakpoint_conditional.PNG "Vs_ide_gs_debug_breakpoint_conditional")  
...
### <a name="inspecting-your-code-at-run-time"></a>Inspecionando seu código em tempo de execução  
 ...
 ![Inspeção do valor de tempo de execução do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_inspect_value.PNG "vs_ide_gs_debug_inspect_value")  
 ...
 ![Janela Ferramentas de Diagnóstico do Visual Studio](~/docs/ide/media/vs_ide_gs_debug_diagnostic_tools.PNG "Vs_ide_gs_debug_diagnostic_tools")  
