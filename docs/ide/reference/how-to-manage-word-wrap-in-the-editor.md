...
---
# Como gerenciar a quebra de texto no Editor
<a id="how-to-manage-word-wrap-in-the-editor" class="xliff"></a>
...
#### Para definir preferências de quebra automática de linha
<a id="to-set-word-wrap-preferences" class="xliff"></a>  
