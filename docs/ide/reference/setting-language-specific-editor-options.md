...
O [!INCLUDE[vsprvs](../../code-quality/includes/vsprvs_md.md)] oferece uma variedade de opções de Editor de Texto que se aplicam a linguagens de programação específicas.  
