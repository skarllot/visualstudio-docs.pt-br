...
- **Habilitar a carga de solução leve**
    ...
    Alguns recursos IDE não estão habilitados nesse modo. Para determinar se essa opção pode ajudar, consulte [Tempo de carregamento de solução mais curto](https://blogs.msdn.microsoft.com/visualstudio/2016/10/11/shorter-solution-load-time-in-visual-studio-15/) e [Otimizar o tempo de inicialização do Visual Studio](https://docs.microsoft.com/en-us/visualstudio/ide/optimize-visual-studio-startup-time#speed-up-solution-load).
