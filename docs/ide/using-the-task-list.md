...
-   No menu **Exibir**, escolha **Lista de Tarefas** (Teclado: Ctrl+\\,T).  
     ...
     ![Janela Lista de Tarefas](~/docs/ide/media/vs2015_task_list.png "vs2015_task_list")  
...
2.  Abra a pasta **Ambiente** e escolha **Lista de Tarefas**.  
     ...
     ![Lista de tarefas do Visual Studio](~/docs/ide/media/vs2015_task_list_options.png "vs2015_task_list_options")  
...
##  <a name="shortcuts"></a> Atalhos  
 ...
 ![Ícone de atalho de lista de tarefas do Visual Studio](~/docs/ide/media/vs2015_task_list_bookmark.png "vs2015_task_list_bookmark")  
