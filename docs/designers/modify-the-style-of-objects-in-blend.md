 ...
 **Assista a um breve vídeo:** ![Configurar recursos instalados](~/docs/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Editor de Pincéis](http://www.popscreen.com/v/6A4mO/Microsoft-Expression-Blend-The-Brushes-Editor).  
 ...
 **Assista a um breve vídeo:** ![Configure Installed Features (Configurar recursos instalados)](~/docs/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Pincéis de Bloco](http://www.popscreen.com/v/6A4iM/Microsoft-Expression-Blend-Tile-Brushes).  
 ...
 **Assista a um breve vídeo:** ![Configurar recursos instalados](~/docs/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Criar um estilo](http://www.microsoft.com/showcase/details.aspx?uuid=9b8e86e2-8e90-4d61-81af-fa5b5afb3e95).  
  
 **Assista a um breve vídeo:** ![Configurar recursos instalados](~/docs/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Criar um modelo de controle no Expression Blend](http://msdn.microsoft.com/expression/cc263912.aspx).  
...
### <a name="restore-the-default-style-or-template-of-a-control"></a>Restaurar o estilo ou modelo padrão de um controle  
 Selecione o controle e, no painel [Propriedades](http://msdn.microsoft.com/en-us/135a5a5e-ec6d-4f38-8827-60e284cd5f57), localize a propriedade **Estilo** ou **Modelo**. Em seguida, clique em **Opções avançadas** ![](~/docs/designers/media/12e06962-5d8a-480d-a837-e06b84c545bb.png "12e06962-5d8a-480d-a837-e06b84c545bb")e clique em **Redefinir** no menu de atalho.  
 ...
 **Assista a um breve vídeo:** ![Configurar recursos instalados](~/docs/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Gerenciar o estado de seus controles WPF](https://www.youtube.com/watch?v=m0PlkF5i6uw).  
 ...
 **Assista a um breve vídeo:** ![Configurar recursos instalados](~/docs/designers/media/bldadminconsoleinitialconfigicon.PNG "BldAdminConsoleInitialConfigIcon") [Um breve resumo sobre recursos](http://www.popscreen.com/v/6A4k7/Microsoft-Expression-Blend-Brief-Touch-on-Resources).  
