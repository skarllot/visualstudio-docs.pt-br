...
5.  Na barra de menus, escolha **Depurar**, **Iniciar Depuração** (ou pressione F5) para executar o aplicativo.  
     ...
     ![Captura de tela de exemplo de ExpenseIt](~/docs/designers/media/gettingstartedfigure1.png "GettingStartedFigure1")  
...
3.  Crie e execute o aplicativo. A ilustração a seguir mostra a aparência do tempo de execução dos controles criados pelo XAML nesse procedimento.  
     ...
     ![Captura de tela de exemplo de ExpenseIt](~/docs/designers/media/gettingstartedfigure2.png "GettingStartedFigure2")  
...
6.  Se você compilar e executar o aplicativo neste ponto, ele deverá se parecer com a seguinte ilustração:  
     ...
     ![Captura de tela de exemplo de ExpenseIt](~/docs/designers/media/gettingstartedfigure3.png "GettingStartedFigure3")  
...
4.  Escolha o botão **Exibir**.  
     ...
     ![Captura de tela de exemplo de ExpenseIt](~/docs/designers/media/gettingstartedfigure4.png "GettingStartedFigure4")  
...
6.  Escolha uma pessoa e, em seguida, escolha o botão **Exibir**.  
     ...
     ![Capturas de tela de exemplo de ExpenseIt](~/docs/designers/media/gettingstartedfigure5.png "GettingStartedFigure5")  
