...
---
# <a name="feature-tour-of-profiling-in-visual-studio"></a>Tour pelos recursos de criação de perfil no Visual Studio
...
![Janela Ferramentas de Diagnóstico](~/docs/profiling/media/prof-tour-diagnostic-tools.png "Ferramentas de Diagnóstico")
...
![Exibição do Resumo de Ferramentas de Diagnóstico](~/docs/profiling/media/prof-tour-cpu-and-memory-graph.gif "Resumo de Ferramentas de Diagnóstico")
...
![Habilitar o uso da CPU nas Ferramentas de Diagnóstico](~/docs/profiling/media/prof-tour-enable-cpu-profiling.png "Habilitar o Uso da CPU nas Ferramentas de Diagnóstico")
...
![Exibição de Uso da CPU das Ferramentas de Diagnóstico](~/docs/profiling/media/prof-tour-cpu-usage.png "Uso da CPU das Ferramentas de Diagnóstico")
...
![Exibição "borboleta" de Computador Chamado do Chamador das Ferramentas de Diagnóstico](~/docs/profiling/media/prof-tour-cpu-usage-caller-callee.png "Exibição de Computador Chamado do Chamador das Ferramentas de Diagnóstico")
...
![Exibição Eventos de Ferramentas de Diagnóstico](~/docs/profiling/media/prof-tour-events.png "Exibição Eventos de Ferramentas de Diagnóstico")
...
![Tour pela criação de perfil – PerfTips](~/docs/profiling/media/prof-tour-perf-tips.png "Tour pela criação de perfil – PerfTips")
...
![Exibir Eventos de Análise de Interface do Usuário nas Ferramentas de Diagnóstico](~/docs/profiling/media/prof-tour-ui-analysis.png "Exibir Eventos de Análise de Interface do Usuário da Ferramentas de Diagnóstico")
...
![Criador de Perfil de Desempenho](~/docs/profiling/media/prof-tour-performance-profiler.png "Criador de Perfil de Desempenho")
...
![Ferramenta de criação de perfil de Linha do Tempo do Aplicativo](~/docs/profiling/media/prof-tour-application-timeline.gif "Linha do Tempo do Aplicativo de Tour pela Criação de Perfil")
...
![Ferramenta de criação de perfil de Uso de GPU](~/docs/profiling/media/prof-tour-gpu-usage.png "Uso de GPU de Diagnóstico")
...
![Ferramenta de criação de perfil de Uso de Rede](~/docs/profiling/media/prof-tour-network-usage.png "Uso de Rede de Diagnóstico")

Selecione uma operação na exibição de resumo para exibir mais detalhes.

![Informações detalhadas na ferramenta de Uso de Rede](~/docs/profiling/media/prof-tour-network-usage-details.png "Detalhes de Uso de Rede de Diagnóstico")
...
![Ferramenta de Gerenciador de Desempenho](~/docs/profiling/media/prof-tour-performance-explorer.png "Gerenciador de Desempenho")
