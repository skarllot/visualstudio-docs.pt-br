...
## <a name="see-also"></a>Consulte também  
 [Memória de JavaScript](../profiling/javascript-memory.md) [Criação de perfil no Visual Studio](../profiling/index.md) [Tour pelos recursos de criação de perfil](../profiling/profiling-feature-tour.md) [Práticas recomendadas de desempenho para aplicativos da Windows Store em C++, C# e Visual Basic](http://msdn.microsoft.com/library/windows/apps/hh750313.aspx)   
