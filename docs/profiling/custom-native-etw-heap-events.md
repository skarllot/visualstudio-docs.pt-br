...
![Alocação de heap do Windows](~/docs/profiling/media/heap-example-windows-heap.png)
...
![Habilitar a criação de perfil de heap](~/docs/profiling/media/heap-enable-heap.png)
...
![Seleção de heap](~/docs/profiling/media/heap-example-custom-heap.png)
...
![Heap NT com controlador](~/docs/profiling/media/heap-example-windows-heap.png)
