...
7.  Enquanto o depurador estiver em pausa, habilite a coleta dos dados de Uso da CPU e, em seguida, abra a guia **Uso da CPU**.
     ...
     ![Ferramentas de Diagnóstico, Habilitar a Criação de Perfil de CPU](~/docs/profiling/media/DiagToolsEnableCPUProfiling.png "DiagToolsEnableCPUProfiling")
...
9.  Selecione a região que você deseja analisar na linha do tempo da CPU (precisa ser uma região que mostre dados de criação de perfil).
     ...
     ![Ferramentas de Diagnóstico, Selecionando um Segmento de Tempo](~/docs/profiling/media/DiagToolsSelectTimeSegment.png "DiagToolsSelectTimeSegment")

     O criador de perfil começa a preparar os dados de thread. Aguarde sua conclusão.

     ![Ferramentas de Diagnóstico, Preparando Threads](~/docs/profiling/media/DiagToolsPreparingThreads.png "DiagToolsPreparingThreads")
  
     A ferramenta de Uso de CPU exibe o relatório na guia **Uso da CPU**.
  
     ![Guia Uso da CPU da Ferramentas de Diagnóstico](~/docs/profiling/media/DiagToolsCPUUsageTab.png "DiagToolsCPUUsageTab")
...
1. Na lista de funções, examine as funções que fazem a maior parte do trabalho.
    ...
    ![Lista de Funções de Uso de CPU das Ferramentas de Diagnóstico](~/docs/profiling/media/DiagToolsCPUUsageFunctionList.png "DiagToolsCPUUsageFunctionList")
...
2. Na lista de funções, clique duas vezes em uma das funções do aplicativo que está trabalhando muito.
    ...
    ![Exibição Chamador/Computador Chamado da Chamada das Ferramentas de Diagnóstico](~/docs/profiling/media/DiagToolsCallerCallee.png "DiagToolsCallerCallee")
...
3. Se você quiser ver uma exibição de nível superior mostrando a ordem em que as funções são chamadas, selecione **Árvore de Chamadas** na lista suspensa, na parte superior do painel.
    ...
    ![Árvore de Chamadas das Ferramentas de Diagnóstico](~/docs/profiling/media/DiagToolsCallTree.png "DiagToolsCallTree")
...
![Escolha Filtrar Exibição, em seguida, Mostrar Código Externo](~/docs/profiling/media/DiagToolsShowExternalCode.png "DiagToolsShowExternalCode")  
