...
![Animação do uso de um trecho de código para inserir uma chamada de read.csv](~/docs/rtvs/media/code-snippet-expansion.gif)
...
![Caixa de diálogo de trechos de código para R](~/docs/rtvs/media/code-snippet-dialog.png)
