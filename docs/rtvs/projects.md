...
![Conteúdo de um projeto R criado usando um modelo](~/rtvs/media/projects-template-results.png)
...
![Gerenciador de Soluções do Visual Studio mostrando vários projetos relacionados em uma solução](~/rtvs/media/projects-polyglot.png)
