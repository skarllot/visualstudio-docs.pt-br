...
![Caixa de diálogo de aviso de certificado autoassinado](~/docs/rtvs/media/workspaces-remote-self-signed-certificate-warning.png)
...
![Comando Importar certificado](~/docs/rtvs/media/workspaces-remote-certificate-import.png)
...
1. Na caixa de diálogo que aparece, selecione **Adicionar** e insira `NETWORK SERVICE` como o nome da conta:
    ...
    ![Caixa de diálogo Gerenciar Chaves Privadas, adicionando NETWORK_SERVICE](~/docs/rtvs/media/workspaces-remote-manage-private-key-dialog.png)
