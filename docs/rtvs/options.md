...
As configurações são acessadas por meio do menu **Ferramentas do R > Opções** ou de **Ferramentas > Opções** e rolando até **Ferramentas do R**:
  ...
  ![Caixa de diálogo de opções para Ferramentas de R](~/docs/rtvs/media/options-dialog.png)
...
![Layout da janela do cientista de dados no Visual Studio](~/docs/rtvs/media/installation-data-scientist-layout-result.png)
