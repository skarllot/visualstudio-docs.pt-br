...
![Coloração de sintaxe para código R](~/rtvs/media/editing-syntax-colors.png)
...
![Opções de fontes e cores para código R](~/rtvs/media/editing-syntax-colors-options.png)

O Visual Studio também sublinha erros de sintaxe no editor:

![Realce de erro de sintaxe no código R](~/rtvs/media/editing-syntax-error.png)
...
![Animação de formatação embutida](~/rtvs/media/editing-inline-formatting.gif)
...
![Animação de recuo automático](~/rtvs/media/editing-auto-indentation.gif)
...
![Criando uma região recolhível com comentários](~/rtvs/media/editing-collapsible-regions.gif)
...
![Animação para definição de espiada](~/rtvs/media/editing-peek-definition.gif)
...
Aplicar a formatação a limpará deixando assim:
...
![Animação da inserção de um comentário Roxygen](~/rtvs/media/editing-roxygen-comments.gif)
