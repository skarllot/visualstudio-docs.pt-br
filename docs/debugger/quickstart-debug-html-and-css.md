...
11. Na janela Explorador do DOM, selecione o elemento DIV correspondente à seção cuja ID é `"fView"`. Use as teclas de seta para exibir e selecionar o elemento DIV correto. \(A tecla de seta para a direita permite que você exiba os filhos de um elemento.\)  
     ...
     ![DOM Explorer](~/docs/debugger/media/js_dom_explorer.png "JS\_DOM\_Explorer")  
...
3.  Escolha o botão **Atualizar aplicativo do Windows** na barra de ferramentas Depurar \(ou pressione F4\). O botão tem esta aparência: ![Atualizar botão de aplicativo do Windows](~/docs/debugger/media/js_refresh.png "JS\_Refresh").  
...
-   Usando o comando `select`, que é um dos [Comandos do Console JavaScript](../debugger/javascript-console-commands.md).  
 ...
 ![Selecione o elemento botão no Explorer do DOM](~/docs/debugger/media/js_dom_select_element_button.png "JS\_DOM\_Select\_Element\_Button")  
