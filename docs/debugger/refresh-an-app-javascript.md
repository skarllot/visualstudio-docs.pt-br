...
7.  Clique no botão **Atualizar aplicativo do Windows**, que tem esta aparência: ![Atualizar botão de aplicativo do Windows](~/docs/debugger/media/js_refresh.png "JS\_Refresh").  \(Ou pressione F4.\)  
