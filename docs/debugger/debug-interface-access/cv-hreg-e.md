...
> [!NOTE]
>  Porque a enumeração de `CV_HREG_e` é muito grande duplicar em sua totalidade aqui, uma versão abreviada é fornecida como uma referência.  Entradas ausentes notated em itálico.  A enumeração completo está disponível no arquivo de cabeçalho de cvconst.h.  
...
## Elements  
 CV\_REG\_\*  
 Usados pelos registros 80x86 e ix86 processadores Intel, e p\- código.  
  
 CV\_R68\_\*  
 Registros usados pelo processador 68K.  
  
 CV\_M4\_\*  
 Os registros MIPS usado pelo processador de 4000 fx\-series.  
  
 CV\_ALPHA\_\*  
 Registros usados pelo processador alfa de série de Digital Equipment Corporation AXP.  
  
 CV\_PPC\_\*  
 Registros usados pelo processador de Motorola\/IBM PowerPC.  
  
 CV\_SH3\_\* e CV\_SH\_\*  
 Registros usados pelo processador SH série de Hitachi SH3 e de Hitachi.  
  
 CV\_ARM\_\*  
 Registros usados por processadores avançados de \(ARM\) do computador RISC.  
  
 CV\_IA64\_\*  
 Registros usados por processadores Intel série de IA64.  
  
 CV\_TRI\_\*  
 Registros usados pelo processador de Infineon Technologies TriCore.  
  
 CV\_AM33\_\*  
 Registros usados por Matsushita\/Panasonic AM33 e processadores relacionados.  
  
 CV\_M32R\_\*  
 Registros usados pelo processador de Mitsubishi M32R.  
  
## Comentários  
 Cada tipo do processador usa seu próprio conjunto exclusivo de registros.  
  
 Os valores na enumeração são passados para os seguintes métodos:  
