...
## [Introdução (SDK de Acesso à Interface de Depuração)](getting-started-debug-interface-access-sdk.md)
### [Visão geral (SDK de Acesso à Interface de Depuração)](overview-debug-interface-access-sdk.md)
...
## [Referência do SDK de Acesso à Interface de Depuração](debug-interface-access-sdk-reference.md)
