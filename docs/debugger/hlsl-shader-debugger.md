...
O depurador HLSL no analisador de elementos gráficos do Visual Studio o ajuda a entender como o código do sombreador HLSL opera em condições reais do seu aplicativo.  
 ...
 ![Depuração usando HLSL Assista e janelas de pilha de chamada.](~/docs/debugger/graphics/media/gfx_diag_demo_hlsl_debugger_orientation.png "gfx\_diag\_demo\_hlsl\_debugger\_orientation")  
