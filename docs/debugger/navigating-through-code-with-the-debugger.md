...
1.  **Defina pontos de interrupção no código**  
     ...
     ![Definir um ponto de interrupção](~/docs/debugger/media/dbg_basics_setbreakpoint.png "DBG\_Basics\_SetBreakpoint")  
 ...
 **Executar uma função especificada pelo nome**  
 ...
 ![Caixa de diálogo Novo ponto de interrupção](~/docs/debugger/media/dbg_execution_newbreakpoint.png "DBG\_Execution\_NewBreakpoint")  
 ...
 ![Escolha a caixa de diálogo pontos de interrupção](~/docs/debugger/media/dbg_execution_overloadedbreakpoints.png "DBG\_Execution\_OverloadedBreakpoints")  
...
##  <a name="BKMK_Set_the_next_statement_to_execute"></a> Definir a próxima instrução a executar  
 ...
 ![Exemplo2](~/docs/debugger/media/dbg_basics_example2.png "DBG\_Basics\_Example2")  
