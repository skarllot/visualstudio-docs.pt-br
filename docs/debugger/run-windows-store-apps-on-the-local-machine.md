...
-   Em projetos C\# e Visual Basic, clique em **Depurar** e escolha **Computador Local** da lista suspensa **Dispositivo de Destino**.  
     ...
     ![Página de propriedades de projeto C&#35; e Visual Basic](~/docs/debugger/media/vsrun_cs_vb_projprop_local.png "VSRUN\_CS\_VB\_ProjProp\_Local")  
...
-   Em projetos C\+\+ e JavaScript, expanda o nó **Propriedades de Configuração**, clique em **Depurar** e escolha **Depurador Local** da lista **Depurador a iniciar**.  
     ...
     ![Página de propriedades do projeto C&#43;&#43; e JavaScript](~/docs/debugger/media/vsrun_cpp_js_projprop_local.png "VSRUN\_CPP\_JS\_ProjProp\_Local")  
