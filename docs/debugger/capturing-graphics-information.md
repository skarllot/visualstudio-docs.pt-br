...
-   No Visual Studio, no **gráficos** barra de ferramentas, escolha o **capturar quadro** botão![Ícone de botão de captura de gráficos](../debugger/media/debuggingdirectxgraphics.png "DebuggingDirectXGraphics").  
