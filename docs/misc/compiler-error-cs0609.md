...
Não é possível definir o IndexerName atributo em um indexador marcado como substituir  
 ...
 O atributo de nome \(**IndexerNameAttribute**\) não pode ser aplicado a uma propriedade indexada é uma substituição. Para obter mais informações, consulte [indexadores](/dotnet/csharp/programming-guide/indexers/index).  
