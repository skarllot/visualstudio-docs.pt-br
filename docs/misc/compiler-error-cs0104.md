...
'referência' é uma referência ambígua entre 'identifier' e 'Identificador'  
 ...
 Contém o programa [usando](/dotnet/csharp/language-reference/keywords/using) diretivas para dois namespaces e seu código referencia um nome que aparece nos dois namespaces.  
