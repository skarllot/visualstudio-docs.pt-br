...
Um arquivo de recursos em seu projeto não segue o formato padrão para um arquivo de recursos do Windows ou há uma incompatibilidade entre o arquivo de recurso e o [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] projeto.  
