...
Declaração não é válida. Use ' operações de operador de \< tipo \> \(... ' em vez disso  
 ...
 O tipo de retorno para um usuário definido [operador](/dotnet/csharp/language-reference/keywords/operator) deve aparecer antes do operador de palavra\-chave.  
