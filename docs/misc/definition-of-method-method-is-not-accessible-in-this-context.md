...
-   Adicione o método como uma função de agregação personalizada \(método de extensão\). Para obter mais informações sobre como criar uma função de agregação personalizada, consulte [Cláusula Aggregate](/dotnet/visual-basic/language-reference/queries/aggregate-clause).  
