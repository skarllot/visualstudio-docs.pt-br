...
Todos os projetos em uma [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] solução deve ter a mesma plataforma como destino, mas o projeto que você está adicionando visa uma plataforma diferente daquele especificado pela sua solução.  
