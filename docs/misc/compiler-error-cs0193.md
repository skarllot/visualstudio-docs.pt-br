...
O \* ou \-\> operador deve ser aplicado a um ponteiro  
 ...
 O **\*** ou **\-\>** operador foi usado com um tipo de nonpointer. Para obter mais informações, consulte [Tipos de ponteiro](/dotnet/csharp/programming-guide/unsafe-code-pointers/pointer-types).  
