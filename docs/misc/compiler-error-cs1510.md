...
Ref ou out argumento deve ser uma variável pode ser atribuída  
 ...
 Somente uma variável pode ser passada como um [ref](/dotnet/csharp/language-reference/keywords/ref) parâmetro em uma chamada de método. Um `ref` valor é como passar um ponteiro.  
