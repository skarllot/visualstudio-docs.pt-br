...
Delegate 'del' não obtém argumentos 'number'  
 ...
 O número de argumentos passados para um [Delegar](/dotnet/csharp/language-reference/keywords/delegate) invocação não concorda com o número de parâmetros na declaração do delegado.  
