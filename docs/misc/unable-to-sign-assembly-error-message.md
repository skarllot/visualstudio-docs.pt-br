...
O [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] compilador chama o vinculador de Assembly \(Al.exe, também conhecido como Alink\) para gerar um assembly com um manifesto. O vinculador relatou um erro ao assinar o assembly depois que ele foi criado. Isso pode ser devido a uma chave inválida.  
