...
'member': membros de interface não podem ter uma definição  
 ...
 Métodos que são declarados em um [interface](/dotnet/csharp/language-reference/keywords/interface) devem ser implementados em uma classe que herda dela e não na própria interface.  
