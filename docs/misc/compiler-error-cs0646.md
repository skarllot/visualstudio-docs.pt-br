...
Não é possível especificar o atributo DefaultMember em um tipo que contém um indexador  
 ...
 Se uma classe ou outro tipo especifica **System.Reflection.DefaultMemberAttribute**, ele não pode conter um indexador. Para obter mais informações, consulte [propriedades](/dotnet/csharp/programming-guide/classes-and-structs/properties).  
