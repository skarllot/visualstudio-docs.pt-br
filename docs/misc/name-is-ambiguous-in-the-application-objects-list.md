...
Você forneceu um nome que é ambíguo e, portanto, está em conflito com outro nome. O [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] compilador não tem nenhuma regra de resolução de conflitos; você deve eliminar a ambigüidade por conta própria. A lista fornecida nos detalhes da mensagem de erro, os objetos de aplicativo onde o nome é ambíguo.  
