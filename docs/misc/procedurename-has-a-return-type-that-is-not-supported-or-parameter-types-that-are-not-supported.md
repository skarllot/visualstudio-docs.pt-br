...
Um procedimento é declarado com parâmetros ou um tipo de retorno não pode ser representado por [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
...
## Consulte também  
 [Tipos de dados](/dotnet/visual-basic/language-reference/data-types/data-type-summary)