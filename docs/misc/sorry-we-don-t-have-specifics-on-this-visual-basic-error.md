...
Desculpe, mas não temos informações específicas sobre este erro. Você pode procurar o texto de mensagem e um número de erro localizar informações na web. Ou, você pode solicitar outros desenvolvedores usando um destes fóruns:  
 ...
 Fornece um fórum para perguntas e discussões gerais sobre do [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] sintaxe de linguagem e compilador.  
  
 [Atualização e interoperabilidade do Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145966)  
 Fornece um fórum para perguntas sobre e problemas com a atualização para [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] e trabalhar com os recursos de interoperabilidade.  
  
 [IDE do Visual Basic](http://go.microsoft.com/fwlink/?LinkId=145971)  
 Fornece um fórum para perguntas sobre como trabalhar no [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] ambiente.  
  
 [Visual Basic\-geral](http://go.microsoft.com/fwlink/?LinkId=145973)  
 Fornece um fórum para perguntas sobre e problemas com [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] que não são discutidas em outros fóruns.  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/vb.net)  
 Fornece um fórum para perguntas sobre e problemas com [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
  
 Consulte também:  
 [Recursos adicionais para programadores do Visual Basic](/dotnet/visual-basic/getting-started/additional-resources)  
  
## Consulte também  
 [Guia de programação do Visual Basic](/dotnet/visual-basic/programming-guide/index)   
