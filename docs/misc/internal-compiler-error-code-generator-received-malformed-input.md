...
O [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] compilador não pode interpretar com sucesso um dos seus arquivos gravados internamente.  
...
2.  Se o erro persistir, reinstale o [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)] compilador.  
