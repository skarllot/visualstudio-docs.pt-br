...
## Consulte também  
 ...
 [Combinação eficiente de operadores](/dotnet/visual-basic/programming-guide/language-features/operators-and-expressions/efficient-combination-of-operators)   
 [Precedência do operador no Visual Basic](/dotnet/visual-basic/language-reference/operators/operator-precedence)