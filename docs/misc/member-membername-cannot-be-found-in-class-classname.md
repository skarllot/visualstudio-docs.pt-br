...
2.  Se o erro persistir, salve seu trabalho e reinicie o [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)].  
  
3.  Se o erro persistir, reinstale [!INCLUDE[vbprvb](../code-quality/includes/vbprvb_md.md)].  
