...
Falha na inicialização de uma classe. Uma causa possível é danificado [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] instalação.  
...
2.  Reinstale o [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)] e recompilar o programa.  
