...
## Consulte também  
 ...
 [Instrução Mid](/dotnet/visual-basic/language-reference/statements/mid-statement)   
 [Diretiva \#Const](/dotnet/visual-basic/language-reference/directives/const-directive)   
