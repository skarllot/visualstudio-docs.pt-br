...
1. Essa ação cria um `test1.py file with code that imports the standard `unittest` module, derives a test class from `unittest.TestCase`, and invokes `unittest.main()` se você executar o script diretamente:
