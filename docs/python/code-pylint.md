...
![Comando PyLint no menu de contexto em projetos do Python](~/docs/python/media/code-pylint-command.png)
...
![Lista de erros do PyLint](~/docs/python/media/code-pylint-error-list.png)
