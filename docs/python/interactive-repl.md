...
![Janela interativa do Python](~/python/media/interactive-window.png)
...
![Link Janela Interativa na janela Ambientes do Python](~/python/media/interactive-window-opening.png)
...
![Itens de menu da Janela Interativa em Exibir > Outras Janelas](~/python/media/interactive-window-menu.png)
...
![Executar Projeto no menu Python Interativo](~/python/media/interactive-execute-project.png)
...
![Escopos da janela interativa](~/python/media/interactive-scopes.png)
...
![Janela interativa no escopo de importlib](~/python/media/interactive-importlib-scope.png)
...
![Comando de menu Enviar para interativa](~/python/media/interactive-send-to.png)
