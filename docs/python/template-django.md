...
- Variáveis de contexto passadas para o modelo:
    ...
    ![IntelliSense para variáveis de contexto](~/docs/python/media/template-django-intellisense.png)

- Marcação e filtragem para elementos internos e definidos pelo usuário:

    ![IntelliSense para marcas e filtros](~/docs/python/media/template-django-intellisense-filter.png)
...
![Pontos de interrupção](~/docs/python/media/template-django-debugging.png)
