...
![Novos modelos de projeto Web](~/python/media/template-web-new-project.png)
...
![Caixa de diálogo que instala os pacotes necessários para um modelo de projeto](~/python/media/template-web-requirements-txt-wizard.png)
...
Quando um projeto Web for iniciado para depuração, o Visual Studio iniciará o servidor Web localmente e abrirá o navegador padrão nesse endereço e nessa porta. Para especificar opções adicionais, clique com o botão direito do mouse no projeto, selecione **Propriedades**e selecione a guia **Inicializador da Web**:
  ...
  ![Propriedades do inicializador da Web para o modelo da Web genérico](~/python/media/template-web-launcher-properties.png)
...
![Comando Publicar em um menu de contexto do projeto](~/python/media/template-web-publish-command.png)
...
![Adicionar a Extensão de Site no portal do Azure](~/python/media/template-web-site-extensions.png)
...
![Modelos de item do Azure](~/python/media/template-web-azure-items.png)
...
![Alterando a configuração de publicação](~/python/media/template-web-publish-config.png)
...
![Comando Converter em Projeto do Serviço de Nuvem do Microsoft Azure](~/python/media/template-web-convert-menu.png)
