...
> [!Warning]
> No momento, o Visual Studio 2017 Preview travará quando esses avisos forem ignorados. Verifique se todos os problemas foram corrigidos antes de tentar se conectar.
