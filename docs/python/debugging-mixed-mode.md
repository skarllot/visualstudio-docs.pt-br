...
![Depuração de modo misto](~/docs/python/media/mixed-mode-debugging.png) 
...
1. Clique com o botão direito do mouse no projeto, no Gerenciador de Soluções, selecione **Propriedades**, selecione a guia **Depuração** e, em seguida, ative a opção para **Habilitar a depuração de código nativo**. Isso habilita o modo misto em todas as sessões de depuração.
    ...
    ![Habilitando a depuração de código nativo](~/docs/python/media/mixed-mode-debugging-enable-native.png)
...
1. Ao anexar o depurador de modo misto a um processo existente (**Depurar > Anexar ao Processo...**), selecione o botão **Selecionar...**  para abrir a caixa de diálogo **Selecionar Tipo de Código**, defina a opção **Depurar esses tipos de código** e selecione **Nativo** e **Python** na lista:
    ...
    ![Selecionando os tipos de código Nativo e do Python](~/docs/python/media/mixed-mode-debugging-code-type.png)
...
>
> ![Selecionando Python como o tipo de depuração ao anexar um depurador](~/docs/python/media/mixed-mode-debugging-attach-type.png)
...
![Pilha de chamadas combinada](~/docs/python/media/mixed-mode-debugging-call-stack.png)
...
![Exibição do Python](~/docs/python/media/mixed-mode-debugging-python-view.png)
...
![Habilitando a exibição do Python](~/docs/python/media/mixed-mode-debugging-enable-python-view.png)
...
![Habilitando a exibição do C++](~/docs/python/media/mixed-mode-debugging-enable-cpp-view.png)
...
![Exibição do C++](~/docs/python/media/mixed-mode-debugging-cpp-view.png)
