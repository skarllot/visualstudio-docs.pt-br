...
![Pontos de interrupção no Visual Studio](~/docs/python/media/debugging-breakpoints.png)
...
![Criando um tracepoint com um ponto de interrupção](~/docs/python/media/debugging-tracepoint.png)
...
![DataTips no depurador](~/docs/python/media/debugging-quick-tips.png)
...
![Janela Automáticos no depurador](~/docs/python/media/debugging-autos-window.png)
...
![Janela Locais no depurador](~/docs/python/media/debugging-locals-window.png)
...
![Janela Inspeção no depurador](~/docs/python/media/debugging-watch-window.png)
...
![Visualizadores de cadeia de caracteres](~/docs/python/media/debugging-string-visualizers.png)
...
![Pop-up de exceção](~/docs/python/media/debugging-exception-popup.png)
...
![Janela Exceções](~/docs/python/media/debugging-exception-settings.png)
...
![Propriedades de depuração de projeto](~/docs/python/media/debugging-project-properties.png)
...
![Janela Interativa de Depuração do Python](~/docs/python/media/debugging-interactive.png)
...
![Opções da Janela Interativa de Depuração](~/docs/python/media/debugging-interactive-options.png)
