...
O `Product` é o elemento XML nível superior dentro de um arquivo de produto.  
...
## Elementos e atributos  
 O `Product` elemento é necessário em um arquivo de produto.  Ele tem o atributo a seguir.  
...
## Exemplo  
 O exemplo de código a seguir mostra um arquivo completo de produtos para instalar o [!INCLUDE[dnprdnshort](../code-quality/includes/dnprdnshort_md.md)].  
