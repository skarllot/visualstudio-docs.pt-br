...
Clique nos nomes de edições na tabela a seguir para ver as IDs de carga de trabalho e de componente disponíveis que você precisará para instalar o Visual Studio usando uma linha de comando ou para especificar como uma dependência em um manifesto do VSIX.
