...
>  Uma instalação personalizada inclui automaticamente os componentes que estão em uma instalação padrão.  
 ...
 A lista completa de componentes personalizados é o seguinte:  
  
|Conjuntos de recursos|Componentes|  
|---------------------------|-----------------|  
|**Atualizações**|Visual Studio 2015 atualização 3|  
|**Linguagens de programação**|Visual C\+\+<br /><br /> Visual F\#<br /><br /> Ferramentas Python para Visual Studio|  
|**Desenvolvimento do Windows e da Web**|Ferramentas de publicação do ClickOnce<br /><br /> LightSwitch<br /><br /> Ferramentas de desenvolvedor do Microsoft Office<br /><br /> Microsoft SQL Server Data Tools<br /><br /> Ferramentas de desenvolvedor da Microsoft<br /><br /> Ferramentas do PowerShell para Visual Studio \[3ª parte\]<br /><br /> Kit de desenvolvimento do Silverlight<br /><br /> Ferramentas de desenvolvimento de aplicativo universal do Windows<br /><br /> SDKs e ferramentas do Windows 10<br /><br /> Windows 8.1 e Windows Phone 8.0\/8.1 ferramentas<br /><br /> SDKs e ferramentas do Windows 8.1|  
|**Desenvolvimento móvel em plataforma cruzada**|C\# \/ .NET \(Xamarin\)<br /><br /> HTML\/JavaScript \(Apache Cordova\)<br /><br /> Desenvolvimento em Visual C\+\+ móveis para iOS \/ Android<br /><br /> Clang com o Microsoft CodeGen|  
|**Ferramentas comuns e Kits de desenvolvimento de Software**|Kit de desenvolvimento nativo Android \[3ª parte\]<br /><br /> SDK do Android \[3ª parte\]<br /><br /> APIs de instalação do SDK do Android \[3ª parte\]<br /><br /> Apache Ant \[3ª parte\]<br /><br /> Java SE Development Kit \[3ª parte\]<br /><br /> Joyent Node. js \[3ª parte\]|  
|**Ferramentas comuns**|Git para Windows \[3ª parte\]<br /><br /> Extensão do GitHub para Visual Studio \[3ª parte\]<br /><br /> Ferramentas de extensibilidade do Visual Studio|  
  
##  <a name="installing"></a> Instalando o Visual Studio  
 Você pode instalar o Visual Studio usando a mídia de instalação \(DVDs\), baixando um instalador da web de [Downloads do Visual Studio](http://go.microsoft.com/fwlink/?LinkId=517106) do site ou pela criação de um layout de instalação offline.  
  
> [!IMPORTANT]
>  Você precisa ter credenciais de administrador para instalar [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)]. No entanto, você não precisa usar o [!INCLUDE[vsprvs](../code-quality/includes/vsprvs_md.md)] após a instalação.  
...
|Gerenciar o log de auditoria e segurança|SeSecurityPrivilege|  
  
 Para obter mais informações sobre esse requisito de conta de administrador local, consulte o artigo da Base de dados de Conhecimento [instalação do SQL Server falhará se a conta de instalação não tem determinados direitos de usuário](https://support.microsoft.com/en-us/kb/2000257).  
