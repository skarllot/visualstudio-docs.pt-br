...
1.  Localize o Instalador do Visual Studio no computador.  
     ...
     ![Instalador do Visual Studio](~/docs/install/media/vs2017-locate-the-visual-studio-installer.PNG "Localizar o Instalador do Microsoft Visual Studio")
...
2.  Clique para iniciar o instalador, clique no ícone ![Detalhes], no ícone (media/vs2017uninstall-UninstallIcon.png "Selecionar as Opções") e, em seguida, em **Desinstalar**.  
     ...
     ![Modificando o Visual Studio 2017: Modificar, iniciar, reparar ou desinstalar](~/docs/install/media/vs2017-uninstall.PNG "Reparar ou desinstalar o Visual Studio 2017")  

3.  Clique em **OK** para confirmar sua escolha.

     ![Modificando o Visual Studio 2017: Desinstalar o produto](~/docs/install/media/vs2017-uninstall-confirm.PNG "Confirmar para desinstalar o Visual Studio 2017")  
